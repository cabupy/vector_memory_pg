...
3. Instala 5 comandos slash en `.claude/commands/`
...
Al inicio de cada sesión Claude Code cargará el contexto vía `CLAUDE.md`.
...
Muestra si `CLAUDE.md`, los comandos y la conexión MCP están configurados correctamente.
